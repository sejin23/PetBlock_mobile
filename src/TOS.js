export const TermOfService = `제 1 장 총칙\n

제1조(목적) 이 약관은 PetBlock 회사(전자상거래 사업자)가 운영하는 PetBlock Application(이하 “몰”이라 한다)에서 제공하는 모바일 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 모바일 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.\n
